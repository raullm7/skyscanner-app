...
```json
  "homepage": "https://myusername.github.io/skyscanner-app",
```
...
To publish it at [https://myusername.github.io/skyscanner-app](https://myusername.github.io/skyscanner-app), run:
